...
urlpatterns = [
    ...
    path('speakers//', SpeakerDetailView.as_view(), name='speaker-detail'),
    path('speakers//update/', SpeakerUpdateView.as_view(), name='speaker-update'),
    path('speakers//delete/', SpeakerDeleteView.as_view(), name='speaker-delete'),
    
    # Tag URLs
    path('tags/', EventTagListView.as_view(), name='tag-list'),
    path('tags/create/', EventTagCreateView.as_view(), name='tag-create'),
    path('tags//update/', EventTagUpdateView.as_view(), name='tag-update'),
    path('tags//delete/', EventTagDeleteView.as_view(), name='tag-delete'),
    ...
    path('registrations//', EventRegistrationDetailView.as_view(), name='registration-detail'),
    path('registrations//cancel/', EventRegistrationCancelView.as_view(), name='registration-cancel'),
    path('registrations//confirm/', EventRegistrationConfirmView.as_view(), name='registration-confirm'),
    
    # Gallery URLs
    path('/gallery/upload/', EventGalleryCreateView.as_view(), name='gallery-upload'),
    path('gallery//delete/', EventGalleryDeleteView.as_view(), name='gallery-delete'),
]